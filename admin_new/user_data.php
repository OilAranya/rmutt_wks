...
<b style='font-size:30px;'>รายชื่อ ข้อมูลสมาชิก</b>
</div>
...
<form class='form-horizontal' id='frm_type' action="user_new.php?submit=OK&show=OK&Select_ID=<?php echo $Select_ID?>" method="post" enctype='multipart/form-data'>
