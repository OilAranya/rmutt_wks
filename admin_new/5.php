...
if($_GET['action']=='save'){
	...
	header('Content-Disposition: attachment; filename="รายงานตามเปอร์เซ็นต์ที่คาดหวัง.xls"');#ชื่อไฟล์
...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" class='table table-bordered tablesorter'>
  <thead>
  <tr>
    <td align="center" style="font-size:18px; text-align:center;"> รายงานตาม เปอร์เซ็นต์ที่คาดหวัง</td>
  </tr>
  </thead>
</table>
...
<thead>
<tr>
  <td height="30" colspan="9" align='left' style="font-weight:bold;">เปอร์เซ็นต์ที่คาดหวัง <?php echo $_POST['report_id'] ;?>% </td>
  </tr>
<tr>
