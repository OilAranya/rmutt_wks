...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" class='table table-bordered tablesorter'>
  <thead>
  <tr>
    <td align="center" style="font-size:18px; text-align:center;">รายงานตาม ช่วงอายุ</td>
  </tr>
  </thead>
</table>
...
<thead>
<tr>
  <td height="30" colspan="9" align='left' style="font-weight:bold;">อายุระหว่าง <?php echo $_POST['s1']."  ถึง ".$_POST['s2'];?> ปี</td>
  </tr>
<tr>
