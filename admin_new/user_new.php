...
?>
<form name="form1" method="post" action="user_data.php?show=OK&strSearch=Y" class='navbar-form navbar-left' role='search'>
...
<nav>
<ul class='pagination'>
<li <?php if($page==1) echo "class='disabled' ";?>><a href='user_data.php?page=<?php echo $page-1?>&Search=<?php echo$Search?>&Search2=<?php echo $Search2?>&strSearch=<?php echo$strSearch?>' aria-label='Previous'><span aria-hidden='true'>&laquo;</span></a></li>
...
?>
<li <?php if($page==$i) echo "class='active' ";?>><a href='user_data.php?page=<?php echo $i?>&Search=<?php echo $Search?>&Search2=<?php echo $Search2?>&strSearch=<?php echo $strSearch?>' ><?php echo $i?></a></li>
<?php }?>

<li <?php if($page==$total_page) echo "class='disabled' ";?>><a href='user_data.php?page=<?php echo $page+1?>&Search=<?php echo $Search?>&Search2=<?php echo $Search2?>&strSearch=<?php echo $strSearch?>' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>
</ul>
</nav>
...
<?php  if($submit=="Add"){?>
<form class='form-horizontal' id='frm_user' action="user_data.php?submit=OK&show=OK&Select_ID=" method="post"  enctype='multipart/form-data'data-fv-framework='bootstrap'
...
<form class='form-horizontal' id='frm_user' action="user_data.php?submit=OK&show=OK&Select_ID=<?php echo $Select_ID?>" method="post" enctype='multipart/form-data'>
...
<button type='button' class='btn btn-danger' onClick="document.location.href='user_new.php?show=OK'">Cancle</button>
</div>
</div>
</form>
<?php }?>
