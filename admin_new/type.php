...
<b style='font-size:30px;'>TYPE MANAGEMENT</b>
</div>
...
?>
<form name="form1" method="post" action="type.php?show=OK&strSearch=Y" class='navbar-form navbar-left' role='search'>
...
<td width="8%"><a href="type.php?submit=Add&show=" class='btn btn-success btn-md' role='button'>Add New</a></td>
</tr>
</thead>
<tbody>
<?php 
...
<td align="center">
<a href="type.php?submit=Edit&Select_ID=<?php echo $autoid;?>"  title='Edit' class='btn btn-warning btn-xs'>Edit</a>&nbsp;&nbsp;
<a href="type.php?submit=DEL&show=OK&Select_ID=<?php echo $autoid;?>" title='Delete' class='confirm_delete btn btn-danger btn-xs' data-show="<?php echo $arr['auto_id'] ?>">Del</a>
</td>
</tr>
<?php }?>
</tbody>
...
<nav>
<ul class='pagination'>
<li <?php if($page==1) echo "class='disabled' ";?>><a href='type.php?page=<?php echo $page-1?>&Search=<?php echo$Search?>&Search2=<?php echo $Search2?>&strSearch=<?php echo$strSearch?>' aria-label='Previous'><span aria-hidden='true'>&laquo;</span></a></li>
...
?>
<li <?php if($page==$i) echo "class='active' ";?>><a href='type.php?page=<?php echo $i?>&Search=<?php echo $Search?>&Search2=<?php echo $Search2?>&strSearch=<?php echo $strSearch?>' ><?php echo $i?></a></li>
<?php }?>

<li <?php if($page==$total_page) echo "class='disabled' ";?>><a href='type.php?page=<?php echo $page+1?>&Search=<?php echo $Search?>&Search2=<?php echo $Search2?>&strSearch=<?php echo $strSearch?>' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>
</ul>
</nav>
...
<?php  if($submit=="Add"){?>
<form class='form-horizontal' id='frm_type' action="type.php?submit=OK&show=OK&Select_ID=" method="post"  enctype='multipart/form-data'data-fv-framework='bootstrap'
...
<button type='button' class='btn btn-danger' onClick="document.location.href='type.php?show=OK'">Cancle</button>
</div>
</div>
</form>
<?php }?>
...
<form class='form-horizontal' id='frm_type' action="type.php?submit=OK&show=OK&Select_ID=<?php echo $Select_ID?>" method="post" enctype='multipart/form-data'>
